...
<div class="col g-ml-45 g-ml-0--lg g-pb-65--md">
    ...
    {{-- Form Start --}}
    <div class="g-pa-20">
        <h1 class="g-font-weight-300 g-font-size-28 g-color-black g-mb-28">Edit User</h1>
                            ...
                            <div class="col-md-6">
                                <div class="form-group g-mb-30">
                                    ...
                                    <div class="g-pos-rel">
                                        ...
                                        <input id="name" class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-px-14 g-py-10" type="text" name="name" value="{{ $user->name }}" required/> 
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group g-mb-30">
                                    ...
                                    <div class="g-pos-rel">
                                        ...
                                        <input id="email" class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-px-14 g-py-10" type="email" name="email" value="{{ $user->email }}"  required/> 
                                    </div>
                                </div>
                            </div>
